        ...
        <div className="row">
            <div className="col-md-12">
                ...
                <p className="blurb_pad">
                    ...
                    to over 70lbs! The lake also has a large native population
                    of Bass, Bream, Carp, and Crappie. Our bait and tackle shop
                    is stocked with rods, reels, bait and tackle. We make sure
                    to carry everything you need to get fishing.
                </p>
                <div className="col-md-12">
