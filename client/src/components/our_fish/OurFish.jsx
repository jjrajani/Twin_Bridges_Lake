...
class OurFish extends Component {
    componentDidMount() {
        setAndSendPageview(window, '/our_fish');
    }
                ...
                <div className="row">
                    <div className="col-xs-12">
                        ...
                        <p>
                            ...
                            raised catfish to insure the best eating quality. We
                            also periodically stock Monster Catfish always over
                            40lbs for those thrill seeking anglers.
                        </p>
                        <div className="col-xs-10 col-xs-offset-1 col-md-8 col-md-offset-2">
                            <div className="alert alert-success text-center top_pad">
                                We do not feed our fish so you know they're
                                always biting.
                            </div>
                        </div>
                    </div>
